...
public class InstantiatingBeanTest {
    ...
    public void testConstructorDependencyInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/instantiatingBean.xml");
    ...
    public void testStaticFactoryDependencyInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/staticFactory.xml");
    ...
    public void testInstanceFactoryDependencyInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/instanceFactory.xml");
    ...
    public void testSetterDependencyInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/setterDependencyInject.xml");
...
//=====================依赖注入扩展部分，注入常量=================================
    ...
    public void testBooleanInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/booleanInject.xml");
    ...
    public void testIdRefInject() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/idRefInject.xml");
    ...
    public void testListInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/listInject.xml");
    ...
    public void testSetInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/setInject.xml");
    ...
    public void testCollectionInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/collectionInject.xml");
    ...
    public void testArrayInject() {
        ...
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/arrayInject.xml");
    ...
    public void testMapInject() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/mapInject.xml");
    ...
    public void testPropertiesInject() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/propertiesInject.xml");
        ...
        System.out.println(propertiesBean2.getValues().containsValue("22,"));
    }

    //注入其他Bean类型值 通过ref bean
    @Test
    public void testBeanInject() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("di/beanInject.xml");
        //通过构造器方式注入
    ...
    //注入其他Bean类型值 通过ref parent
    @Test
    public void testLocalAndparentBeanInject() {
        //初始化父容器
        ApplicationContext parentBeanContext = new ClassPathXmlApplicationContext("di/parentBeanInject.xml");
        //初始化当前容器
        ApplicationContext beanContext = new ClassPathXmlApplicationContext(new String[] {"di/childBeanInject.xml"}, parentBeanContext);
        //该Bean引用parent bean
        HelloApi bean2 = beanContext.getBean("bean1", HelloApi.class);
        bean2.sayHello();
    }
    ...
    public void testInnerBeanInject() {
        ApplicationContext context = new ClassPathXmlApplicationContext("di/innerBeanInject.xml");

        HelloApi bean = context.getBean("bean1", HelloApi.class);
        bean.sayHello();
    }
...
//            ApplicationContext context = new ClassPathXmlApplicationContext("di/navigationBeanInject.xml");
//
//            //获取导航Bean
