...
public class SpELTest {
    ...
    public void helloWorld() {
        ...
        TestCase.assertEquals("Hello World!", expression.getValue(context));
    }
    ...
    public void testParserContext() {
        ...
        TestCase.assertEquals("Hello World!", expression.getValue());
    }
    ...
    public void testArithmeticExpression() {
        ...
        TestCase.assertEquals(-3, result1);
    ...
    public void testLogicalExpression() {
        ...
        TestCase.assertEquals(true, result1);
    ...
    public void testClassTypeExpression() {
        ...
        TestCase.assertEquals(String.class, result1);
        ...
        TestCase.assertEquals(SpELTest.class, result2);

        //类静态字段访问
        int result3 = parser.parseExpression("T(Integer).MAX_VALUE").getValue(int.class);
        TestCase.assertEquals(Integer.MAX_VALUE, result3);

        //类静态方法调用
        int result4 = parser.parseExpression("T(Integer).parseInt('1')").getValue(int.class);
        TestCase.assertEquals(1, result4);
    }
    ...
    public void testConstructorExpression() {
        ...
        TestCase.assertEquals("haha", result1);
    ...
    public void testVariableExpression() {
        ...
        TestCase.assertEquals("haha", result2);

        String result3 = parser.parseExpression("#this").getValue(context, String.class);
        TestCase.assertEquals("haha", result3);
    }
    ...
    public void testMethodExpression() {
        ...
        TestCase.assertEquals("ha", result1);
        Date date = new Date();
        StandardEvaluationContext context = new StandardEvaluationContext(date);
    ...
    public void testBeanExpression() {
        ...
        TestCase.assertEquals(System.getProperties(), result1);
    }
    ...
    public void testInnerListExpression() {
        ...
        TestCase.assertEquals(new Integer(1), result1.get(0));
        try {
            result1.set(0, 2);
            //不可能执行到这，对于字面量列表不可修改
            TestCase.fail();
        ...
        TestCase.assertEquals(0, result2.size());

        String expression3 = "{{1+2,2+4},{3,4+4}}";
        List<List<Integer>> result3 = parser.parseExpression(expression3).getValue(List.class);
        result3.get(0).set(0, 1);
        TestCase.assertEquals(2, result3.size());
    }
    ...
    public void testListAndMapGetValueExpression() {
        ...
        //即list.get(0)
        TestCase.assertEquals(1, result1);
        ...
        TestCase.assertEquals(2, result2);
        ...
        TestCase.assertEquals(1, result3);
    }
    ...
    public void testListAndMapSetValueExpression() {
        ...
        TestCase.assertEquals(3, result2);
        ...
        TestCase.assertEquals(4, result2);
        ...
        TestCase.assertEquals(2, result3);
    ...
    public void testProjectionExpression() {
        ...
        TestCase.assertEquals(new Integer(5), result1.iterator().next());
        ...
        TestCase.assertEquals(2, result2.size());
    }
    ...
    public void testSelectExpression() {
        ...
        TestCase.assertEquals(1, result1.size());
        TestCase.assertEquals(new Integer(5), result1.iterator().next());
        ...
        TestCase.assertEquals(1, result2.size());

        List<Integer> result3 = parser.parseExpression("#map.?[key != 'a'].![value+1]").getValue(context2, List.class);
        TestCase.assertEquals(new Integer(3), result3.iterator().next());
    }
    ...
    public void testTemplateExpression() {
        ...
        TestCase.assertEquals("Error 1 2", result);
    ...
    public void testXmlExpression() {
        ...
        TestCase.assertEquals("Hello World!", hello1);
        TestCase.assertEquals("Hello World!", hello2);
        TestCase.assertEquals("Hello World!", hello3);
    }
    ...
    public void testAnnotationExpression() {
        ...
        TestCase.assertEquals("Hello World!", helloBean1.getValue());

        SpELBean helloBean2 = ctx.getBean("helloBean2", SpELBean.class);
        TestCase.assertEquals("haha", helloBean2.getValue());
    }
    ...
    public void testPrefixExpression() {
        ...
        SpELBean helloBean2 = ctx.getBean("helloBean2", SpELBean.class);
        TestCase.assertEquals("Hello World!", helloBean2.getValue());
    }
